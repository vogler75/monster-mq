...
def test_message_expiry_basic():
    ...
    subscriber.subscribe("test/msg_expiry/expiry", qos=1, properties=props)
    time.sleep(0.5)
...
def test_message_expiry_delivered():
    ...
    props = Properties(PacketTypes.SUBSCRIBE)
    subscriber.subscribe("test/msg_expiry/valid", qos=1, properties=props)
    time.sleep(0.5)
...
def test_expiry_interval_update():
    ...
    props = Properties(PacketTypes.SUBSCRIBE)
    subscriber.subscribe("test/msg_expiry/update", qos=1, properties=props)
    time.sleep(0.5)
...
def test_no_expiry():
    ...
    props = Properties(PacketTypes.SUBSCRIBE)
    subscriber.subscribe("test/msg_expiry/noexpiry", qos=1, properties=props)
    time.sleep(0.5)
