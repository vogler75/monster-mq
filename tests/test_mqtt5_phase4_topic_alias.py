#!/usr/bin/env python3
"""
Test MQTT v5.0 Topic Aliases (Phase 4).
...
- Run: python tests/test_mqtt5_phase4_topic_alias.py
...
def test_mqtt5_topic_alias():
    ...
    print("=" * 70)
    print("MQTT v5.0 Topic Alias Test (Phase 4)")
    print("=" * 70)
    ...
    # Create clients
    publisher_id = f"test_mqtt5_phase4_pub_{int(time.time())}"
    subscriber_id = f"test_mqtt5_phase4_sub_{int(time.time())}"
