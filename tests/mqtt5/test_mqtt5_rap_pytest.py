...
def test_rap_multiple_subscribers(publisher_client, clean_topic, rap_value, expected_retain, broker_config):
    """
...
def test_rap_with_wildcard_subscriptions(publisher_client, subscriber_client, message_collector, clean_topic, broker_config):
    """
