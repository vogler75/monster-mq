#!/usr/bin/env bash
# ==============================================================================
# MonsterMQ Setup & Installer Launcher (macOS & Linux)
#
# Downloads and launches the native MonsterMQ Setup tool (interactive web wizard
# with schema-driven config editor and Java 21+ environment verification).
#
# Quick install:
