 ...
 */
class ClusterSetMapReplicator(
    private val vertx: Vertx,
    private val eventBusAddress: String,
    loggerName: String = "ClusterSetMapReplicator"
) {
    private val logger: Logger = Utils.getLogger(ClusterSetMapReplicator::class.java, loggerName)
