...
class MetricsResolver(
                    ...
                    if (result.succeeded()) {
                        future.complete(result.result().map { bm ->
                            BrokerMetrics(
                                ...
                                subscriptionCount = bm.subscriptionCount,
    ...
    data class BrokerConfig(
        ...
        val questDbUrl: String,
        val questDbUser: String,
    ...
    fun brokerConfig(): DataFetcher<BrokerConfig> {
        return DataFetcher {
            ...
            BrokerConfig(
                ...
                questDbUrl = config.getJsonObject("QuestDB", io.vertx.core.json.JsonObject()).getString("Url", ""),
                questDbUser = config.getJsonObject("QuestDB", io.vertx.core.json.JsonObject()).getString("User", ""),
