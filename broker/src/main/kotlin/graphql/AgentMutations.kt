...
class AgentMutations(
    ...
    private fun inputToDeviceConfig(input: Map<String, Any>): DeviceConfig {
        ...
        val agentConfig = AgentConfig(
            ...
            allowedPublishTopics = parseStringList(input["allowedPublishTopics"]),
    ...
    private fun mergeAgentConfig(existing: DeviceConfig, input: Map<String, Any>): DeviceConfig {
        ...
        val merged = AgentConfig(
            ...
            allowedPublishTopics = if (input.containsKey("allowedPublishTopics")) parseStringList(input["allowedPublishTopics"]) else existingConfig.allowedPublishTopics,
