...
class InfluxDBLoggerQueries(private val vertx: Vertx, private val deviceStore: IDeviceConfigStore) {
    private val logger: Logger = Utils.getLogger(InfluxDBLoggerQueries::class.java)

    fun influxdbLoggers(): DataFetcher<CompletableFuture<List<Map<String, Any?>>>> {
        return DataFetcher { env ->
            ...
            val filter: (DeviceConfig) -> Boolean = { dev ->
                dev.type == DeviceConfig.DEVICE_TYPE_INFLUXDB_LOGGER &&
