 ...
 */
class OpcUaServerNamespace(server: OpcUaServer, private val namespaceUri: String) : AddressSpaceComposite(server), Namespace, Lifecycle {

    private val lifecycleManager = LifecycleManager()
    private val namespaceIndexValue: UShort = server.namespaceTable.add(namespaceUri)
    ...
    override fun getNamespaceIndex(): UShort = namespaceIndexValue
}