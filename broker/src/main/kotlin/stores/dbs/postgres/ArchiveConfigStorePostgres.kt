                    ...
                    connection.prepareStatement(sql).use { preparedStatement ->
                        ...
                        while (resultSet.next()) {
                            ...
                            val archiveGroup = ArchiveGroup(
                                ...
                                lastValRetentionMs = Utils.parseDuration(lastValRetention),
                                archiveRetentionMs = Utils.parseDuration(archiveRetention),
                                purgeIntervalMs = Utils.parseDuration(purgeInterval),
