            ...
            row.innerHTML = `
                ...
                <td>
                    <div class="action-buttons">
                        <button class="btn-icon btn-view" onclick="neo4jClientManager.viewClient('${client.name}')" title="Edit Client" aria-label="Edit Client">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/></svg>
                        </button>
                        <button class="btn-icon ${client.enabled ? 'btn-pause' : 'btn-play'}" onclick="neo4jClientManager.toggleClient('${client.name}', ${!client.enabled})" title="${client.enabled ? 'Disable Client' : 'Enable Client'}" aria-label="${client.enabled ? 'Disable Client' : 'Enable Client'}">
                        ...
                        <button class="btn-icon btn-delete" onclick="neo4jClientManager.deleteClient('${client.name}')" title="Delete Client" aria-label="Delete Client">
