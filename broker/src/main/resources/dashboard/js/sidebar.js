    ...
    renderMenu() {
        const menuConfig = [
            ...
            },
            {
                ...
                items: [
                    {
                        href: '/pages/topic-schema-policies.html',
                        icon: '<path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0 1 12 2.944a11.955 11.955 0 0 1-8.618 3.04A12.02 12.02 0 0 0 3 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path>',
                        text: 'Schema Policies'
                    },
                    {
                        href: '/pages/topic-namespaces.html',
                        icon: '<path d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z"></path>',
                        text: 'Topic Namespaces'
                    }
                ]
            },
            {
