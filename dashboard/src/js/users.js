class UserManager {
    ...
    isAdmin() {
        return safeStorage.getItem('monstermq_isAdmin') === 'true';
    }
                ...
                <tr>
                    ...
                    <td>
                        <div style="display: flex; gap: 0.5rem;">
                            <ix-icon-button icon="highlight" variant="subtle-tertiary" size="24" class="edit-user-btn" title="Edit"
                                    data-username="${this.escapeHtml(user.username)}"></ix-icon-button>
                            <ix-icon-button icon="trashcan" variant="subtle-tertiary" size="24" class="btn-delete delete-user-btn" title="Delete"
                                    data-username="${this.escapeHtml(user.username)}"></ix-icon-button>
                        </div>
                    </td>
                </tr>
