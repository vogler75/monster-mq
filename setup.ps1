# ==============================================================================
# MonsterMQ Setup Launcher (Windows PowerShell)
#
# Downloads and launches the latest native MonsterMQ Setup executable (setup.exe)
...
#
# Options:
#   powershell -c "& { irm https://raw.githubusercontent.com/vogler75/monster-mq/main/setup.ps1 | iex } -cli"
# ==============================================================================
...
if ($Help) {
    Write-Host "MonsterMQ Setup Launcher for Windows" -ForegroundColor Cyan
    Write-Host ""
    Write-Host "Usage: setup.ps1 [-Cli] [-Unattended] [-Dir <path>] [-Version <tag>]"
    Write-Host ""
    Write-Host "Options:"
...
Write-Host "                                      Setup Launcher" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    # Cleanup temp setup file on exit
