...
### 1-Line Setup & Installer (macOS & Linux)

Downloads the native setup tool, verifies Java 21+, and opens the interactive configuration wizard in your browser:
...
```bash
git clone git@github.com:vogler75/monster-mq.git
cd monster-mq
cd broker
